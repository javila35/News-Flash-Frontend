 ...
 */
export const CommentForm: React.FC<CommentFormProps> = ({ bookmarkId, currentUserId, }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        api.comments.postComment(payload)
            .then(data => {
                console.log(data)
            });
    }
    ...
    return (
        <div className="comment-form">
            <form onSubmit={e => handleSubmit(e)}>
                ...
                <input type="text" onChange={handleChange} name="comment" placeholder="Enter comment."></input>
