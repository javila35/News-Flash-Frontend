 ...
 * [ ] Type props
 */
export const ArticleCard: React.FC<ArticleCardProps> = ({ article, currentUser }) => {
    ...
    return (
        <Container className="article-card">
            ...
            <div className="user-interaction">
                ...
                {token && currentUser ? <Button className="bookmarker" onClick={() => bookmark()}>Bookmark</Button> : null}
            </div>
        </Container>
    );
};